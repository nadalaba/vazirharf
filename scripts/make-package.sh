...
zip -r "$RELEASEFILEPATH" -q -MM fonts misc Round-Dots Vazirharf-font-face.css Vazirharf-Variable-font-face.css CHANGELOG.md README.md OFL.txt AUTHORS.txt DOCS.txt || exit 1
