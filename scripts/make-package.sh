...
zip -r "$RELEASEFILEPATH" fonts misc Round-Dots Vazirharf-font-face.css Vazirharf-Variable-font-face.css CHANGELOG.md README.md OFL.txt OFL-FAQ.txt FONTLOG.txt AUTHORS.txt DOCS.txt || exit 1
