...
استخدم **وزیرحرف**:
- عندما تحتاج إلى تعطيل ميزة الترابط الحرفي للخط ligatures (لأنك ترغب في متابعة أثر كل حرف تكتبه مباشرةً)، ولكنك لا تزال ترغب في الحفاظ على الشكل الأصلي لترابط حرفي "لام" و"ألف" `لا`.
يكون هذا مفيدًا خصوصًا في منصّات الطباعة التي لا تعتمد على صندوق إدخال تقليدي مثل [monkeytype](https://monkeytype.com). يمكنك رؤية الفرق بوضوح [هنا](https://github.com/monkeytypegame/monkeytype/pull/7552).
- عندما ترغب في الحصول على المساعدة والدعم والتحديثات المستمرة.
