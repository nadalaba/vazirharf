...
- زمانی که لازم دارید لیگچرها را غیرفعال کنید (چون می‌خواهید برای هر کاراکترِ تایپ‌شده بازخورد جداگانه داشته باشید)، اما همچنان می‌خواهید شکل اصلی لیگچر لام‌الف «لا» حفظ شود.
این موضوع به‌ویژه در پلتفرم‌های تایپ که از جعبه ورودی سنتی استفاده نمی‌کنند، مثل [monkeytype](https://monkeytype.com)، بسیار کاربردی است. تفاوت را می‌توانید [اینجا](https://github.com/monkeytypegame/monkeytype/pull/7552) ببینید.
