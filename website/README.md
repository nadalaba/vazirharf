...
```shell
NEXT_PUBLIC_LAST_TAG_NAME= # e.g. 34.003
NEXT_PUBLIC_CDN_URL= # base folder including vazirharf css files (Vazirharf-font-face.css, ...). e.g. "https://cdn.jsdelivr.net/gh/nadalaba/vazirharf@v34.003"
